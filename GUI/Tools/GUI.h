...
class GUI
{
    public:
         ...
         : showcaseMode(showcaseMode)
        {
			...
			std::cout << "GUI: CreateWindow done!" << std::endl;
			...
			std::cout << "GUI: CreateBuffer done!" << std::endl;
			...
			std::cout << "GUI: Create colorProgram done!" << std::endl;

			fxaaProgram = std::shared_ptr<Shader>(loadProgramFromFile("empty.vert", "fxaa.frag", "quad.geom"));

			std::cout << "GUI: Create fxaaProgram done!" << std::endl;
			...
			std::cout << "GUI: Create init done!" << std::endl;
        }
